...
Screen_3ViewBase::Screen_3ViewBase() :
    buttonCallback(this, &Screen_3ViewBase::buttonCallbackHandler)
{
    ...
    textArea1.setTypedText(touchgfx::TypedText(T___SINGLEUSE_A3FB));
    add(textArea1);
...
void Screen_3ViewBase::setupScreen()
{

}

void Screen_3ViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &button2)
    {
        //button2Handler
...
void Screen_3ViewBase::handleTickEvent()
{
    //buttonHandler
